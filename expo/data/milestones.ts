...
const GOLD_MILESTONES: Milestone[] = [
  { id: "gold_1",    title: "A Humble Beginning",    desc: "Earn your first gold coin.",                   check: (s) => s.totalGoldEarned >= 1 },
  ...
  { id: "gold_1b",   title: "The Eternal Kingdom",   desc: "1 billion gold. You are legend.",              check: (s) => s.totalGoldEarned >= 1_000_000_000 },
  ...
  { id: "gold_1t",   title: "The Golden Age",        desc: "1 trillion gold earned.",                      check: (s) => s.totalGoldEarned >= 1_000_000_000_000 },
  ...
  { id: "gold_1q",   title: "Timeless Wealth",       desc: "1 quadrillion gold earned.",                   check: (s) => s.totalGoldEarned >= 1_000_000_000_000_000 },
  { id: "gold_1qi",  title: "The Infinite Vault",    desc: "1 quintillion gold. You have transcended.",    check: (s) => s.totalGoldEarned >= 1_000_000_000_000_000_000 },
];
...
const GPS_MILESTONES: Milestone[] = [
  { id: "gps_1",    title: "Trickle",            desc: "Reach 1 gold per second.",           check: (s) => s.totalGPS >= 1 },
  ...
  { id: "gps_1m",   title: "Gold Storm",         desc: "Reach 1 million gold per second.",   check: (s) => s.totalGPS >= 1_000_000 },
  ...
  { id: "gps_1b",   title: "Infinite Flow",      desc: "Reach 1 billion gold per second.",   check: (s) => s.totalGPS >= 1_000_000_000 },
...
const CLICK_MILESTONES: Milestone[] = [
  { id: "clicks_1",    title: "The First Tap",     desc: "Tap the realm for the first time.",   check: (s) => s.totalClicks >= 1 },
...
const UPGRADE_MILESTONES: Milestone[] = [
  { id: "upg_1",   title: "Progress!",         desc: "Purchase your first upgrade.",      check: (s) => s.purchasedUpgrades.length >= 1 },
...
interface BuildingSpec { id: string; name: string; titles: [string, string, string, string] }
const BUILDING_SPECS: BuildingSpec[] = [
  { id: "peasant_hut",     name: "Peasant Hut",     titles: ["First Subject",       "Peasant Quarter",     "Peasant Army",        "Nation of Peasants"] },
  { id: "market_stall",    name: "Market Stall",    titles: ["Open for Business",   "Marketplace",         "Trade Hub",           "Merchant Empire"] },
  { id: "blacksmith",      name: "Blacksmith",      titles: ["Forged in Fire",      "Iron Works",          "Master Forge",        "Steel Nation"] },
  { id: "apothecary",      name: "Apothecary",      titles: ["First Remedy",        "Healing Quarter",     "Grand Apothecary",    "Elixir Empire"] },
  { id: "tavern",          name: "Tavern",          titles: ["The First Round",     "Ale District",        "Brewery Kingdom",     "Realm of Revelry"] },
  { id: "mill",            name: "Mill",            titles: ["The First Mill",      "Grain District",      "Breadbasket Kingdom", "Harvest Empire"] },
  { id: "harbor",          name: "Harbor",          titles: ["First Port",          "Trading Port",        "Naval Power",         "Ocean Empire"] },
  { id: "barracks",        name: "Barracks",        titles: ["First Soldier",       "Standing Army",       "Warrior Nation",      "Military Empire"] },
  { id: "cathedral",       name: "Cathedral",       titles: ["First Blessing",      "Holy District",       "Divine Nation",       "Theocracy"] },
  { id: "castle_tower",    name: "Castle Tower",    titles: ["First Fortification", "Walled Realm",        "Fortress Nation",     "Impenetrable Empire"] },
  { id: "royal_treasury",  name: "Royal Treasury",  titles: ["The Vaults Open",     "Gilded Quarter",      "Bullion Standard",    "Gold Standard"] },
  { id: "palace",          name: "Palace",          titles: ["Seat of Power",       "Royal District",      "Imperial Court",      "Palace of Eternity"] },
  { id: "wizard_tower",    name: "Wizard's Tower",  titles: ["First Spell",         "Mage Circle",         "Arcane Nation",       "Tower of Infinity"] },
  { id: "dragon_aerie",    name: "Dragon's Aerie",  titles: ["First Dragon",        "Dragon Flight",       "Dragon Empire",       "Age of Dragons"] },
  { id: "coliseum",        name: "Coliseum",        titles: ["First Arena",         "The Circuit",         "Champion Empire",     "Eternal Games"] },
  { id: "celestial_spire", name: "Celestial Spire", titles: ["First Stargazer",     "Astral Circle",       "Cosmic Empire",       "Infinite Cosmos"] },
  { id: "realms_forge",    name: "Realm's Forge",   titles: ["First Forging",       "Forgemaster Circle",  "Reality Forge",       "Forge of Eternity"] },
  { id: "eternal_throne",  name: "Eternal Throne",  titles: ["The Throne Claims You","Circle of Eternity", "Eternal Empire",      "Immortal Dominion"] },
];

const THRESHOLDS = [1, 25, 100, 200] as const;
...
const PRESTIGE_MILESTONES: Milestone[] = [
  { id: "prestige_1",  title: "Sovereign",       desc: "Declare Sovereignty for the first time.", check: (s) => s.prestigeCount >= 1 },
  ...
  { id: "prestige_10", title: "Empire",          desc: "Ten kingdoms risen.",                     check: (s) => s.prestigeCount >= 10 },
  { id: "prestige_25", title: "Eternal Ruler",   desc: "Twenty-five kingdoms risen.",             check: (s) => s.prestigeCount >= 25 },
  { id: "prestige_50", title: "The Undying",     desc: "Fifty kingdoms. You cannot be stopped.",  check: (s) => s.prestigeCount >= 50 },
  { id: "prestige_100",title: "Godking",         desc: "One hundred sovereignties declared.",     check: (s) => s.prestigeCount >= 100 },
];
...
const COIN_MILESTONES: Milestone[] = [
  { id: "coins_1",   title: "Fortune Favours",    desc: "Collect your first Golden Coin.",    check: (s) => s.goldenCoinsCollected >= 1 },
...
const LEGACY_MILESTONES: Milestone[] = [
  { id: "legacy_first", title: "The Long Memory",   desc: "Purchase your first Legacy Upgrade.", check: (s) => (s.legacyUpgrades?.length ?? 0) >= 1 },
  ...
  { id: "legacy_all",   title: "Eternal Legacy",    desc: "Own all 20 Legacy Upgrades.",         check: (s) => (s.legacyUpgrades?.length ?? 0) >= 20 },
];
